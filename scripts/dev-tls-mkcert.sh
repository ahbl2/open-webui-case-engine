...
echo "Optional full stack (see docs/STACK_STARTUP.md):"
echo "  source scripts/export-dev-tls-env.sh   # this repo: Vite proxy flags + PEM paths"
echo "  ./scripts/stack-https.sh              # prints 3-terminal recipe"
echo "Case Engine (separate repo): export CASE_ENGINE_TLS_KEY_FILE / CASE_ENGINE_TLS_CERT_FILE — docs/operations/LOCAL_HTTPS_DEV.md"
echo ""
echo "Restart Vite: npm run dev -- --host 0.0.0.0   |   or: npm run dev:https"
