<script lang="ts">
	...
	import CasesSection from './Sidebar/CasesSection.svelte';
					...
					<div class="px-[0.4375rem] mt-1 mb-0.5">
						...
						>
							<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
								stroke-width="2" stroke="currentColor" class="size-4.5 shrink-0">
						...
						<!-- Search (triggers existing search modal) -->
						<button
							class="w-full flex items-center space-x-3 rounded-2xl px-2.5 py-2 text-gray-800 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-900 transition"
