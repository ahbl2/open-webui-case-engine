...
export const DS_PROPOSALS_CLASSES = {
	...
	/** P128 page: tab row + fixed right “Create” — inner scroll; see detectiveSurfaces */
	tabStripWithEndAction: 'ds-proposals-tab-strip ds-proposals-tab-strip--with-end-action',
	tabStripScroll: 'ds-proposals-tab-strip__scroll',
	tabStripEndAction: 'ds-proposals-tab-strip__end-action',
	tabDivider: 'ds-proposals-tab-divider',
	doctrineBand: 'ds-proposals-doctrine-band',
	authorityBanner: 'ds-proposals-authority-banner',
	statusSummary: 'ds-proposals-status-summary',
	statusSummaryGrid: 'ds-proposals-status-summary__grid',
	statusSummaryCard: 'ds-proposals-status-summary__card',
	statusSummaryIcon: 'ds-proposals-status-summary__icon',
	statusSummaryBody: 'ds-proposals-status-summary__body',
	statusSummaryLabel: 'ds-proposals-status-summary__label',
	statusSummaryCount: 'ds-proposals-status-summary__count',
	statusSummaryHint: 'ds-proposals-status-summary__hint',
	filterRow: 'ds-proposals-filter-row',
	/** One horizontal row: type + (search | spacer); scoped to Proposals list toolbar */
	filterSearchRow: 'ds-proposals-filter-search-row',
	filterToolbar: 'ds-proposals-filter-toolbar',
...
export const DS_ENTITY_BOARD_CLASSES = {
	...
	registryHeaderTop: 'ds-entity-registry-header-top',
	/** P132 — compact + ADD in card header (next to title actions). */
	registryHeaderAdd: 'ds-entity-registry-header-add',
	registryHeaderDivider: 'ds-entity-registry-header-divider',
	registryKindIcon: 'ds-entity-registry-kind-icon',
	registryFooterAdd: 'ds-entity-registry-footer-add',
	registryFooterControls: 'ds-entity-registry-footer-controls',
	registryPoiBadge: 'ds-entity-registry-poi-badge',
	registryRowMeta: 'ds-entity-registry-row-meta',
	registryRowRole: 'ds-entity-registry-row-role',
	...
	/** Close Details control in entity detail header (focus mode). */
	focusBackBtn: 'ds-entity-focus-back-btn',
	/** Right column: detail workspace as one bordered L-frame (P69-08). */
	focusDetailWrap: 'ds-entity-focus-detail-wrap',
...
export const DS_ENTITY_DETAIL_CLASSES = {
	...
	chromeBar: 'ds-entity-detail-chrome-bar',
	chromeTitle: 'ds-entity-detail-chrome-title',
	chromeToolbar: 'ds-entity-detail-chrome-toolbar',
	chromeStatusPill: 'ds-entity-detail-chrome-status-pill',
	chromeStatusPillActive: 'ds-entity-detail-chrome-status-pill--active',
	chromeStatusPillRetired: 'ds-entity-detail-chrome-status-pill--retired',
	chromeEditBtn: 'ds-entity-detail-chrome-edit-btn',
	chromeMoreBtn: 'ds-entity-detail-chrome-more-btn',
	profilePanel: 'ds-entity-detail-profile-panel',
	/** P132 — PERSON focus header: 3-col photo / identity / record-details (EntityDetailWorkspace). */
	personHeaderLayout: 'ds-entity-detail-person-header-layout',
	personHeaderPhoto: 'ds-entity-detail-person-header-photo',
	personHeaderCenter: 'ds-entity-detail-person-header-center',
	personHeaderIdentityStack: 'ds-entity-detail-person-header-identity-stack',
	personHeaderIdentityRow: 'ds-entity-detail-person-header-identity-row',
	/** P132 — DOB + age as two field pairs in one identity row. */
	personHeaderIdentityDobWithAge: 'ds-entity-detail-person-header-identity-dob-with-age',
	/** P132 — one label+value pair inside the DOB+age row. */
	personHeaderIdentityFieldPair: 'ds-entity-detail-person-header-identity-field-pair',
	personHeaderIdentityLabel: 'ds-entity-detail-person-header-identity-label',
	personHeaderIdentityValue: 'ds-entity-detail-person-header-identity-value',
	personHeaderAlertRow: 'ds-entity-detail-person-header-alert-row',
	personHeaderRiskCluster: 'ds-entity-detail-person-header-risk-cluster',
	personHeaderRecordCard: 'ds-entity-detail-person-header-record-card',
	/** P132 — PERSON pre-tab two-row summary root (EntityDetailWorkspace). */
	personPretabSummary: 'ds-entity-detail-person-pretab-summary',
	/** P132 — large rectangular portrait frame in PERSON pre-tab row 1. */
	personPretabPortraitCard: 'ds-entity-detail-person-pretab-portrait-card',
	/** P132 — hero portrait image (3:4 card, not small square). */
	portraitPretabHero: 'ds-entity-detail-portrait--pretab-hero',
	/** P132 — initials fill for pretab hero frame. */
	portraitFallbackPretabHero: 'ds-entity-detail-portrait-fallback--pretab-hero',
	/** P132 — row-1 right rail pair: Physical description (left) + Record details (right). */
	personPretabRow1SideCard: 'ds-entity-detail-person-pretab-row1-side-card',
	/** P132 — pre-tab row 2 grid (Contact / Investigative). */
	personPretabRow2: 'ds-entity-detail-person-pretab-row-2',
	/** P132 — second-row summary card accent (with ds-intelligence-panel). */
	personPretabSummaryCard: 'ds-entity-detail-person-pretab-summary-card',
	/** P132 — integrated 4-col pre-tab top row: single surface (EntityDetailWorkspace). */
	personPretabDashboard: 'ds-entity-detail-person-pretab-dashboard',
	personPretabCol: 'ds-entity-detail-person-pretab-col',
	personPretabColMedia: 'ds-entity-detail-person-pretab-col--media',
	personPretabColIdentity: 'ds-entity-detail-person-pretab-col--identity',
	personPretabColPhysical: 'ds-entity-detail-person-pretab-col--physical',
	personPretabColRecord: 'ds-entity-detail-person-pretab-col--record',
	personPretabSectionTitle: 'ds-entity-detail-person-pretab-section-title',
	personPretabSectionAccent: 'ds-entity-detail-person-pretab-section-accent',
	personPretabRows: 'ds-entity-detail-person-pretab-rows',
	personPretabRow: 'ds-entity-detail-person-pretab-row',
	personPretabLabel: 'ds-entity-detail-person-pretab-label',
	personPretabValue: 'ds-entity-detail-person-pretab-value',
	personPretabRecordScope: 'ds-entity-detail-person-pretab-record-scope',
	/** P132 — tactical / risk strip under identity (deliberate row). */
	personPretabTacticalStrip: 'ds-entity-detail-person-pretab-tactical-strip',
	profileHero: 'ds-entity-detail-profile-hero',
	profileMetaGrid: 'ds-entity-detail-profile-meta-grid',
	roleBadge: 'ds-entity-detail-role-badge',
	roleBadgeVehicle: 'ds-entity-detail-role-badge--vehicle',
	roleBadgeLocation: 'ds-entity-detail-role-badge--location',
	/** P132 — future PHONE / neutral pretab */
	roleBadgePhone: 'ds-entity-detail-role-badge--phone',
	...
	portraitSquare: 'ds-entity-detail-portrait--square',
	portraitFallback: 'ds-entity-detail-portrait-fallback',
	portraitFallbackSquare: 'ds-entity-detail-portrait-fallback--square',
	...
	overviewStory: 'ds-entity-detail-overview-story',
	riskBlock: 'ds-entity-detail-risk-block',
	riskRow: 'ds-entity-detail-risk-row',
	riskDiamond: 'ds-entity-detail-risk-diamond',
	riskDiamondHigh: 'ds-entity-detail-risk-diamond--high',
	riskDiamondMed: 'ds-entity-detail-risk-diamond--med',
	riskDiamondLow: 'ds-entity-detail-risk-diamond--low',
	riskLevelPill: 'ds-entity-detail-risk-level-pill',
	riskLevelHigh: 'ds-entity-detail-risk-level-pill--high',
	riskLevelMed: 'ds-entity-detail-risk-level-pill--med',
	riskLevelLow: 'ds-entity-detail-risk-level-pill--low',
	tagBlock: 'ds-entity-detail-tag-block',
	tagPill: 'ds-entity-detail-tag-pill',
	tagAddBtn: 'ds-entity-detail-tag-add-btn',
	shortcutsStrip: 'ds-entity-detail-shortcuts-strip',
