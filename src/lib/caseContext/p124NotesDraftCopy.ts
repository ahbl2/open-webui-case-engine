...
/** Idle right panel — reinforces non-promotion when nothing selected. */
export const P124_NOTES_IDLE_EMPTY_HINT =
	'Notes stay drafts here; they are not added to the Timeline automatically.';
