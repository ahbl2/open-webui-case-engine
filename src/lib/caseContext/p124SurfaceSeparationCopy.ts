...
/** `title` on sidebar link to Timeline — committed record, distinct from Notes. */
export const P124_NAV_TITLE_TIMELINE =
	'Case timeline — committed entries (official record). Separate from Notes; not a combined stream with other tabs.';

/** `title` on sidebar link to Notes — drafts only. */
