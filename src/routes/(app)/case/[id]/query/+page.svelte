<script lang="ts">
	/**
	 * P102-04 — Single-case query (read-only; Case Engine authority).
	 * P102-05 — `{#key caseId}` remount discards in-flight UI state on case switch (defense-in-depth).
	 */
...
<CaseWorkspaceContentRegion testId="case-query-page">
